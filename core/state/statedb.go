...
func (s *StateDB) DumpJournal() string {
	return s.journal.dump()
}
...
func (s *StateDB) AddRefund(gas uint64) {
	s.journal.append(refundChange{prev: s.refund, after: s.refund + gas})
	s.refund += gas
}
...
func (s *StateDB) createObject(addr common.Address) (newobj, prev *stateObject) {
	...
	if prev == nil {
		...
		s.journal.append(resetObjectChange{prev: prev, prevdestruct: prevdestruct, after: newobj})
	}
